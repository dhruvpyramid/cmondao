...
export const CONTRACTS = {
  CMONToken: {
    address: config.CMONToken.address,
    abi: config.CMONToken.abi
  },
  CMONStaking: {
    address: config.CMONStaking.address,
    abi: config.CMONStaking.abi
  },
  CMONGovernance: {
    address: config.CMONGovernance.address,
    abi: config.CMONGovernance.abi
  }
};
...
export function loadDeployedAddresses() {
  try {
    return {
      ...
      contracts: {
        CMONToken: config.CMONToken.address,
        CMONStaking: config.CMONStaking.address,
        CMONGovernance: config.CMONGovernance.address
      }
    };
  } catch (error) {
